...
{{< hextra/feature-grid >}}
    ...
    {{< hextra/feature-card
         ...
         subtitle="Если вы нуждаетесь в помощи, хотите поделиться своей историей или вступить в группу поддержки в Тбилиси, напишите нам в чат в телеграмм !!! или на почту theshortcircuitorg\@gmail.com"
    >}}
    {{< hextra/feature-card
         icon="heart"
